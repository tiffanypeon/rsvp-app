...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { event_id: @invite.event_id, guest_id: @invite.guest_id, status: @invite.status }
    end
  ...
  test "should update invite" do
    patch :update, id: @invite, invite: { event_id: @invite.event_id, guest_id: @invite.guest_id, status: @invite.status }
    assert_redirected_to invite_path(assigns(:invite))
  end
